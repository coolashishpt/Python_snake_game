...
if init_status[1] > 0:
    ...
    print("Thank you for playing my game [Ashish Prasad Thakur UId :- 16BET1063]")

# Play Surface
size = width, height = 640, 320
playSurface = pygame.display.set_mode(size)
pygame.display.set_caption("Welcome To Ashish Snake Game")

# Colors
orange = pygame.Color(255, 0, 0)
...
def gameOver():
    ...
    GOsurf = myFont.render("Game Over", True, orange)
